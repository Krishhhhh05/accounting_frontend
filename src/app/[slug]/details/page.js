...
function DynamicPage({ params }) {
  ...
  const attachBankDetailsToCompany = async (bank) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/update_company_bank/', {
        method: 'POST',
        headers: {
  ...
  const fetchAdminDetails = async () => {
    try {
      const response = await axios.get(`http://localhost:8000/api/check/${slug}`);
  ...
  const fetchBankDetails = async (adminName) => {
    try {
      const response = await axios.get(`http://localhost:8000/api/get_bank_details/${adminName}`);
  ...
  const fetchIdDetails = async (adminName) => {
    try {
      const response = await axios.get(`http://localhost:8000/api/get_id_details/${adminName}`);
  ...
  const handleBankDetailsSubmit = async (e) => {
    ...
    try {
      console.log("heris")
      const response = await fetch('http://localhost:8000/api/submit_bank_details/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleIdDetailsSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/submit_id_details/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
